...
namespace Disquera_PrograIV.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public ActionResult dis_generos(int? id)
        {
            return RedirectToAction("lista_discos2", "Discoes", new { id = id });
        }
        // GET: Generoes
        ...
        public ActionResult Create([Bind(Include = "gen_id,gen_nom")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "gen_id,gen_nom")] Genero genero)
        {
            if (ModelState.IsValid)
            {
